...
public sealed partial class PhotocopierComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public SoundSpecifier ScanSound = new SoundPathSpecifier("/Audio/DeadSpace/Machines/scanning.ogg");
    ...
    [DataField]
    public SoundSpecifier TonerRestock = new SoundPathSpecifier("/Audio/DeadSpace/Machines/vending_restock_done_cuted.ogg");
}
