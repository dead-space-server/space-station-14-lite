...
public sealed class RadioSystem : EntitySystem
{
    ...
    private readonly Dictionary<string, string[]> _departments = new Dictionary<string, string[]>
    {
        ...
        { "6ca729", ["сервисный отдел", "сервис", "администратор", "шеф", "повар", "ботаник", "бармен", "боксер", "уборщик", "библиотекарь", "священик", "святой отец", "зоотехник", "репортёр", "музыкант"] },
    ...
    public void SendRadioMessage(EntityUid messageSource, string message, RadioChannelPrototype channel, EntityUid radioSource, bool escapeMarkup = true)
    {
        ...
        if (_inventory.HasSlot(messageSource, "id"))
        {
            ...
            if (_inventory.TryGetSlotEntity(messageSource, "id", out var idSlotEntity))
            {
                ...
                job = TryComp(idSlotEntity, out IdCardComponent? idCard) && idCard.LocalizedJobTitle != null
