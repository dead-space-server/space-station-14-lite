...
public sealed class FootPrintsSystem : EntitySystem
{
    ...
    private EntityQuery<FalldownComponent> _layingQuery;
   ...
   public override void Initialize()
   {
       ...
       _layingQuery = GetEntityQuery<FalldownComponent>();
    ...
    private void OnMove(EntityUid uid, FootPrintsComponent comp, ref MoveEvent args)
    {
        ...
        var dragging = mobThreshHolds.CurrentThresholdState is MobState.Critical or MobState.Dead || _layingQuery.TryComp(uid, out var laying) && laying.IsDown;
